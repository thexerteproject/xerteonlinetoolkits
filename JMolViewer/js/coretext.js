...
Clazz_declarePackage ("J.shape");
Clazz_load (["J.api.JmolMeasurementClient", "J.shape.AtomShape", "JU.List"], "J.shape.Measures", ["java.lang.Float", "java.util.Hashtable", "JU.BS", "$.PT", "J.modelset.Measurement", "$.MeasurementData", "J.util.BSUtil", "$.C", "$.Escape", "$.Txt"], function () {
c$ = Clazz_decorateAsClass (function () {
...
}, "~N,J.modelset.Measurement,~B,~B,~B");
$_M(c$, "find", 
function (m) {
...
}, "J.modelset.MeasurementData,~S,~N");
...
Clazz_declarePackage ("J.render");
Clazz_load (["J.render.LabelsRenderer"], "J.render.MeasuresRenderer", ["java.util.Hashtable", "JU.A4", "$.M3", "$.P3", "J.render.FontLineShapeRenderer", "J.util.Measure", "$.Point3fi"], function () {
c$ = Clazz_decorateAsClass (function () {
...
}, "~S,J.util.Point3fi,J.util.Point3fi,J.util.Point3fi");
$_M(c$, "renderTorsion", 
function (s, a, b, c, d) {
var zA = a.sZ - a.sD - 10;
var zB = b.sZ - b.sD - 10;
...
this.renderLabelOrMeasure (this.m.text, s);
}}, "~S,J.util.Point3fi,J.util.Point3fi,J.util.Point3fi,J.util.Point3fi");
...
var diameter = Clazz_floatToInt (mad >= 20 && this.exportType != 1 ? this.viewer.scaleToScreen (Clazz_doubleToInt ((z1 + z2) / 2), mad) : mad);
