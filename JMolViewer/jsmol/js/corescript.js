...
v.setv (J.script.SV.getVariable (Clazz_instanceOf (bsOrList, JU.BS) ? J.util.BSUtil.copy (bsOrList) : bsOrList));
v.intValue = 1;
t.setModified (false);
...
Clazz_declarePackage ("J.script");
Clazz_load (null, "J.script.ScriptMathProcessor", ["java.lang.Float", "java.util.Arrays", "$.Hashtable", "JU.A4", "$.AU", "$.BS", "$.CU", "$.DF", "$.List", "$.M3", "$.M4", "$.P3", "$.P4", "$.PT", "$.V3", "J.modelset.BondSet", "J.script.SV", "$.T", "J.util.BSUtil", "$.Escape", "$.Logger", "$.Quaternion"], function () {
c$ = Clazz_decorateAsClass (function () {
this.chk = false;
