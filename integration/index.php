...
<!--    <p><div class="label"><label for="template">Template id</label></div><input name="template" type="text" id="template" /></p>-->
    ...
    <p><div class="label">
        <label for="template">Template:</label></div><select name="template" id="template">
  <option value="64">Foundation Post 16 Community Challenge</option>
   <option value="69">Foundation Post 16 Global Citizenship Challenge</option>
  <option value="68">Foundation Post 16 Enterprise and Employability Challenge</option>
</select></p>

    <input name="Share" type="button" onClick="doCreate();" value="Share now" id="shareButton">
