<script type="text/javascript">
	var opinion = new function()
	{
		...
		this.trackQuestion = function()
		{
            ...
            if (options[selected].getAttribute("feedback") == null || options[selected].getAttribute("feedback") == undefined)
            {
            	optionFeedback = "";
            }
            else
            {
          	    optionFeedback += "<p>" + x_addLineBreaks(options[selected].getAttribute("feedback"))  + "</p>";
            }
            
            if (options[selected].getAttribute("audioFB") != undefined && options[selected].getAttribute("audioFB") != "")
            {
				optionFeedback += '<div class="audioHolder" data-audio="' + options[selected].getAttribute("audioFB") + '"></div>';
			}
