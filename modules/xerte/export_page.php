 ...
 */
    ...
    echo "<ul type='a'>";
    echo "<li><button type=\"button\" class=\"xerte_button\" onclick=\"property_tab_download('download_frame', 'html5', 'flash', '" . $xerte_toolkits_site->site_url . url_return("xAPI" , $_POST['template_id']) . "')\"><i class=\"fa fa-download\"></i> " . XERTE_EXPORT_XAPI_LINK . "</button></li><br /></ul></li>";
