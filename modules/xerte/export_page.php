 ...
 */
    ...
    echo "<li>" . XERTE_EXPORT_ZIP_OFFLINE . "<ul><li><button type=\"button\" class=\"xerte_button\" onclick=\"property_tab_download('download_frame', 'html5', 'flash', '" . $xerte_toolkits_site->site_url . url_return("export_offline" , $_POST['template_id']) . "')\">" . XERTE_EXPORT_ZIP_OFFLINE_LINK . "</button></li></ul><br /></li>";
    echo "</ol>";
