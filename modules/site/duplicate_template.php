...
function duplicate_template($folder_name_id,$id_to_copy,$tutorial_id_from_post){
	...
	$database_id=database_connect("file_library database connect success","file_library database connect fail");
        ...
        $query_for_framework = "select template_framework from {$prefix}originaltemplatesdetails where template_name = ? ";
        $params = array($tutorial_id_from_post);

	$row_framework = db_query_one($query_for_framework, $params); 
