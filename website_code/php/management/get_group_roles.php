...
// This file can also be called in a POST request to update the user selection in the UI. In this case, the userid of the selected user is expected in the POST parameter "userid"
if(is_user_permitted("useradmin")){
	if(isset($_POST["userid"])){
		changeuserselection_roles(x_clean_input($_POST["userid"]));
	}
}
