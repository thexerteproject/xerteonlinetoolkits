...
foreach(array('site_url', 'apache', 'enable_mime_check', 'mimetypes', 'enable_file_ext_check', 'file_extensions', 'enable_clamav_check', 'clamav_opts', 'LDAP_preference', 'LDAP_filter',
    'integration_config_path', 'admin_username', 'admin_password', 'site_session_name', 'site_title', 'site_name', 'site_logo','alert_banner', 'organisational_logo','welcome_message', 'site_text', 'news_text', 'pod_one', 'pod_two',
