...
foreach(array('site_url', 'apache', 'mimetypes', 'enable_file_ext_checks', 'file_extensions', 'LDAP_preference', 'LDAP_filter', 'integration_config_path', 'admin_username', 'admin_password', 'site_session_name', 
    ...
    'site_email_account', 'headers', 'email_to_add_to_username', 'proxy1', 'port1', 'feedback_list', 'play_edit_preview_query', 'LRS_Endpoint', 'LRS_Key', 'LRS_Secret',
    'file_extensions' ) as $field) {
