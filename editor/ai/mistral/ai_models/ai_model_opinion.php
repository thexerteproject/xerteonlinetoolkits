...
_load_language_file("/editor/ai_models/mistral_model_opinion_ai.inc");
...
$mistral_preset_models->type_list["opinion"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["opinion"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "opinion";