...
_load_language_file("/editor/ai_models/mistral_model_buttonsequence_ai.inc");
...
$mistral_preset_models->type_list["buttonSequence"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["buttonSequence"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "buttonSequence";