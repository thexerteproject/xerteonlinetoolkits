...
_load_language_file("/editor/ai_models/mistral_model_modify_ai.inc");
...
$mistral_preset_models->type_list["modify"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["modify"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "modify";