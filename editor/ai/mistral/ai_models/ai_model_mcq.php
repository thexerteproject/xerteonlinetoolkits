...
_load_language_file("/editor/ai_models/mistral_model_mcq_ai.inc");
...
$mistral_preset_models->type_list["mcq"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["mcq"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "mcq";