...
_load_language_file("/editor/ai_models/mistral_model_navpage_ai.inc");
...
$mistral_preset_models->type_list["navPage"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["navPage"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "navPage";