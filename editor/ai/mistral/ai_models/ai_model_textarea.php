...
_load_language_file("/editor/ai_models/mistral_model_textarea_ai.inc");
...
$mistral_preset_models->type_list["textarea"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["textarea"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "textarea";