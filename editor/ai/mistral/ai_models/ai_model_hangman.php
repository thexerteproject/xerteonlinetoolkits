...
_load_language_file("/editor/ai_models/mistral_model_hangman_ai.inc");
...
$mistral_preset_models->type_list["hangman"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["hangman"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "hangman";