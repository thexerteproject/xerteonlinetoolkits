...
_load_language_file("/editor/ai_models/mistral_model_selectlist_ai.inc");
...
$mistral_preset_models->type_list["selectlist"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["selectlist"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "selectlist";