...
_load_language_file("/editor/ai_models/mistral_model_quiz_ai.inc");
...
$mistral_preset_models->type_list["quiz"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["quiz"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "quiz";