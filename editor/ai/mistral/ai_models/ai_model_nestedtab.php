...
_load_language_file("/editor/ai_models/mistral_model_nestedtab_ai.inc");
...
$mistral_preset_models->type_list["nestedTab"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["nestedTab"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "nestedTab";