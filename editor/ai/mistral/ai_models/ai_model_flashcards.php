...
_load_language_file("/editor/ai_models/mistral_model_flashcards_ai.inc");
...
$mistral_preset_models->type_list["flashCards"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["flashCards"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "flashCards";