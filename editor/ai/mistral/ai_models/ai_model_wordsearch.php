...
_load_language_file("/editor/ai_models/mistral_model_wordsearch_ai.inc");
...
$mistral_preset_models->type_list["wordsearch"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["wordsearch"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "wordsearch";