...
_load_language_file("/editor/ai_models/mistral_model_grid_ai.inc");
...
$mistral_preset_models->type_list["grid"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["grid"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "grid";