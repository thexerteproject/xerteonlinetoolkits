...
_load_language_file("/editor/ai_models/mistral_model_nav_ai.inc");
...
$mistral_preset_models->type_list["nav"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["nav"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "nav";