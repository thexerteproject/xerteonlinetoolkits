...
_load_language_file("/editor/ai_models/mistral_model_crossword_ai.inc");
...
$mistral_preset_models->type_list["crossword"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["crossword"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "crossword";