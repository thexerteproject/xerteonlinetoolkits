...
_load_language_file("/editor/ai_models/mistral_model_text_ai.inc");
...
$mistral_preset_models->type_list["text"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["text"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "text";