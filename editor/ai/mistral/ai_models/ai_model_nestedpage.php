...
_load_language_file("/editor/ai_models/mistral_model_nestedpage_ai.inc");
...
$mistral_preset_models->type_list["nestedPage"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["nestedPage"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "nestedPage";