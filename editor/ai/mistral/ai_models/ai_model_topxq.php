...
_load_language_file("/editor/ai_models/mistral_model_topxq_ai.inc");
...
$mistral_preset_models->type_list["topXQ"] = ["payload" => $payload, "url" => $chat_url];

$mistral_preset_models->prompt_list["topXQ"] = explode(",", $defaultPrompt);

$mistral_preset_models->multi_run[] = "topXQ";