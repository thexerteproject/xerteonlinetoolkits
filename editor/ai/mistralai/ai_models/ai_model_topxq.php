...
_load_language_file("/editor/ai_models/mistralai_model_topxq_ai.inc");
...
$mistralai_preset_models->type_list["topXQ"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["topXQ"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "topXQ";