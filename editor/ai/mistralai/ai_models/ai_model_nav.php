...
_load_language_file("/editor/ai_models/mistralai_model_nav_ai.inc");
...
if ($context === 'standard') {
    $q = LEARNING_PROMPT_NAV;
    $object = LEARNING_RESULT_NAV;
    $defaultPrompt = DEFAULT_PROMPT_NAV;
}
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_NAV_BOOTSTRAP;
    $object = LEARNING_RESULT_NAV_BOOTSTRAP;
    $defaultPrompt = DEFAULT_PROMPT_NAV_BOOTSTRAP;
}
...
$mistralai_preset_models->type_list["nav"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["nav"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "nav";