...
_load_language_file("/editor/ai_models/mistralai_model_navpage_ai.inc");
...
$mistralai_preset_models->type_list["navPage"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["navPage"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "navPage";