...
_load_language_file("/editor/ai_models/mistralai_model_selectlist_ai.inc");
...
$mistralai_preset_models->type_list["selectlist"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["selectlist"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "selectlist";