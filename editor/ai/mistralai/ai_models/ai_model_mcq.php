...
_load_language_file("/editor/ai_models/mistralai_model_mcq_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_MCQ_BOOTSTRAP;
    $object = LEARNING_RESULT_MCQ_BOOTSTRAP;
...
$mistralai_preset_models->type_list["mcq"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["mcq"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "mcq";