<?php
//crossword model using gpt-3.5 turbo
require_once(dirname(__FILE__) . "/../../../../config.php");
_load_language_file("/editor/ai_models/mistralai_model_crossword_ai.inc");
...
$mistralai_preset_models->type_list["crossword"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["crossword"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "crossword";