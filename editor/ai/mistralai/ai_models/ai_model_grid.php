...
_load_language_file("/editor/ai_models/mistralai_model_grid_ai.inc");
...
$mistralai_preset_models->type_list["grid"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["grid"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "grid";