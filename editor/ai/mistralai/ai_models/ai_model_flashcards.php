...
_load_language_file("/editor/ai_models/mistralai_model_flashcards_ai.inc");
...
$mistralai_preset_models->type_list["flashCards"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["flashCards"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "flashCards";