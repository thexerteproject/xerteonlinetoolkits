...
_load_language_file("/editor/ai_models/mistralai_model_gapfill_ai.inc");
...
$mistralai_preset_models->type_list["gapFill"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["gapFill"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "gapFill";