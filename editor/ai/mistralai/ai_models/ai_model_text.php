...
_load_language_file("/editor/ai_models/mistralai_model_text_ai.inc");
...
$mistralai_preset_models->type_list["text"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["text"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "text";