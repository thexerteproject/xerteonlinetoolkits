...
_load_language_file("/editor/ai_models/mistralai_model_quiz_ai.inc");
...
$mistralai_preset_models->type_list["quiz"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["quiz"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "quiz";