...
_load_language_file("/editor/ai_models/mistralai_model_buttonsequence_ai.inc");
...
if ($context === 'standard') {
    ...
    $defaultPrompt = DEFAULT_PROMPT_BUTTONSEQUENCE;
}
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BUTTONSEQUENCE_BOOTSTRAP;
    $object = LEARNING_RESULT_BUTTONSEQUENCE_BOOTSTRAP;
    $defaultPrompt = DEFAULT_PROMPT_BUTTONSEQUENCE_BOOTSTRAP;
}
...
$mistralai_preset_models->type_list["buttonSequence"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["buttonSequence"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "buttonSequence";