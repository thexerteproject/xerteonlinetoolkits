...
_load_language_file("/editor/ai_models/mistralai_model_nestedtab_ai.inc");
...
$mistralai_preset_models->type_list["nestedTab"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["nestedTab"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "nestedTab";