...
_load_language_file("/editor/ai_models/mistralai_model_categories_ai.inc");
...
$mistralai_preset_models->type_list["categories"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["categories"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "categories";