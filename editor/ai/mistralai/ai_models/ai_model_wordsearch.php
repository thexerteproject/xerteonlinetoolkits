...
_load_language_file("/editor/ai_models/mistralai_model_wordsearch_ai.inc");
...
$mistralai_preset_models->type_list["wordsearch"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["wordsearch"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "wordsearch";