...
_load_language_file("/editor/ai_models/mistralai_model_opinion_ai.inc");
...
if ($context === 'standard') {
    ...
    $defaultPrompt = DEFAULT_PROMPT_OPINION;
}
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_OPINION_BOOTSTRAP;
    $object = LEARNING_RESULT_OPINION_BOOTSTRAP;
    $defaultPrompt = DEFAULT_PROMPT_OPINION_BOOTSTRAP;
}
...
$mistralai_preset_models->type_list["opinion"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["opinion"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "opinion";