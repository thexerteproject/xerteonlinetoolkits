...
_load_language_file("/editor/ai_models/mistralai_model_modify_ai.inc");
...
$mistralai_preset_models->type_list["modify"] = ["payload" => $payload, "url" => $chat_url];

$mistralai_preset_models->prompt_list["modify"] = explode(",", $defaultPrompt);

$mistralai_preset_models->multi_run[] = "modify";