...
_load_language_file("/editor/ai_models/openai_model_imgseries_ai.inc");
...
$openAI_preset_models->type_list["imgSeries"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["imgSeries"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "imgSeries";