...
_load_language_file("/editor/ai_models/openai_model_navpage_ai.inc");
...
$openAI_preset_models->type_list["navPage"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["navPage"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "navPage";