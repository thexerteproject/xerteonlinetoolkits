...
_load_language_file("/editor/ai_models/openai_model_singleimg_ai.inc");
...
$openAI_preset_models->type_list["singleImg"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["singleImg"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "singleImg";