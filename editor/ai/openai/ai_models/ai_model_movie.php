...
_load_language_file("/editor/ai_models/openai_model_movie_ai.inc");
...
elseif ($context === 'bootstrap') {
    ...
    $object = LEARNING_RESULT_MOVIE_BOOTSTRAP;
...
$openAI_preset_models->type_list["movie"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["movie"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "movie";