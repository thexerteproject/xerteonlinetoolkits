...
_load_language_file("/editor/ai_models/openai_model_textcorrection_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_TEXTCORRECTION;
    $object = LEARNING_RESULT_BOOTSTRAP_TEXTCORRECTION;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_TEXTCORRECTION;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["textCorrection"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["textCorrection"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "textCorrection";