...
_load_language_file("/editor/ai_models/openai_model_texthighlight_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_TEXTHIGHLIGHT;
    $object = LEARNING_RESULT_BOOTSTRAP_TEXTHIGHLIGHT;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_TEXTHIGHLIGHT;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["textHighlight"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["textHighlight"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "textHighlight";