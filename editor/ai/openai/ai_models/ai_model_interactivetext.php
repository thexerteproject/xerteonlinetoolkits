...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_INTERACTIVETEXT;
    $object = LEARNING_RESULT_BOOTSTRAP_INTERACTIVETEXT;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_INTERACTIVETEXT;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["interactiveText"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["interactiveText"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "interactiveText";