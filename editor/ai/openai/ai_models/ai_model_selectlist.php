...
_load_language_file("/editor/ai_models/openai_model_selectlist_ai.inc");
...
$openAI_preset_models->type_list["selectlist"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["selectlist"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "selectlist";