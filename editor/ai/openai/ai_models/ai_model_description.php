...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_TEXT_DESCRIPTION;
    $object = LEARNING_RESULT_TEXT_DESCRIPTION;
    $defaultPrompt = DEFAULT_PROMPT_TEXT_DESCRIPTION;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["description"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["description"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "description";