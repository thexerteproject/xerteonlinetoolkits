...
_load_language_file("/editor/ai_models/openai_model_buttonquestion_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_BUTTONQUESTION;
    $object = LEARNING_RESULT_BOOTSTRAP_BUTTONQUESTION;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_BUTTONQUESTION;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["buttonQuestion"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["buttonQuestion"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "buttonQuestion";