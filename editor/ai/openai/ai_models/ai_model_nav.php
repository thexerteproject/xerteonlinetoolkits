...
_load_language_file("/editor/ai_models/openai_model_nav_ai.inc");
...
$openAI_preset_models->type_list["nav"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["nav"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "nav";