...
_load_language_file("/editor/ai_models/openai_model_image_ai.inc");
...
$openAI_preset_models->type_list["image"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["image"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "image";