...
_load_language_file("/editor/ai_models/openai_model_sound_ai.inc");
...
$openAI_preset_models->type_list["sound"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["sound"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "sound";