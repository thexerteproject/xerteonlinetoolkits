...
_load_language_file("/editor/ai_models/openai_model_bullets_ai.inc");
...
$openAI_preset_models->type_list["bullets"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["bullets"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "bullets";