...
_load_language_file("/editor/ai_models/openai_model_hangman_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_HANGMAN;
    $object = LEARNING_RESULT_BOOTSTRAP_HANGMAN;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_HANGMAN;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["hangman"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["hangman"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "hangman";