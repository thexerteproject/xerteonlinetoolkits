...
_load_language_file("/editor/ai_models/openai_model_flickr_ai.inc");
...
$openAI_preset_models->type_list["flickr"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["flickr"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "flickr";