...
_load_language_file("/editor/ai_models/openai_model_summary_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_SUMMARY;
    $object = LEARNING_RESULT_BOOTSTRAP_SUMMARY;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_SUMMARY;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["summary"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["summary"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "summary";