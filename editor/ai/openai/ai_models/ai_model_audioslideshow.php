...
_load_language_file("/editor/ai_models/openai_model_audioslideshow_ai.inc");
...
$openAI_preset_models->type_list["audioSlideshow"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["audioSlideshow"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "audioSlideshow";