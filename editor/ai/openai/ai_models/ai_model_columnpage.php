...
_load_language_file("/editor/ai_models/openai_model_columnpage_ai.inc");
...
$openAI_preset_models->type_list["columnPage"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["columnPage"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "columnPage";