...
_load_language_file("/editor/ai_models/openai_model_textmatch_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_TEXTMATCH;
    $object = LEARNING_RESULT_BOOTSTRAP_TEXTMATCH;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_TEXTMATCH;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["textMatch"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["textMatch"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "textMatch";