...
_load_language_file("/editor/ai_models/openai_model_textgraphics_ai.inc");
...
$openAI_preset_models->type_list["textGraphics"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["textGraphics"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "textGraphics";