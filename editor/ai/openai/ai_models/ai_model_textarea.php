...
_load_language_file("/editor/ai_models/openai_model_textarea_ai.inc");
...
$openAI_preset_models->type_list["textarea"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["textarea"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "textarea";