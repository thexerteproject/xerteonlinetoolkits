...
_load_language_file("/editor/ai_models/openai_model_timeline_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_TIMELINE;
    $object = LEARNING_RESULT_BOOTSTRAP_TIMELINE;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_TIMELINE;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["timeline"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["timeline"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "timeline";