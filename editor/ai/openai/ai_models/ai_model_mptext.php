...
_load_language_file("/editor/ai_models/openai_model_mptext_ai.inc");
...
$openAI_preset_models->type_list["mpText"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["mpText"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "mpText";