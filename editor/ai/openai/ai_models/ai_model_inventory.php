...
_load_language_file("/editor/ai_models/openai_model_inventory_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_INVENTORY;
    $object = LEARNING_RESULT_BOOTSTRAP_INVENTORY;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_INVENTORY;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["inventory"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["inventory"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "inventory";