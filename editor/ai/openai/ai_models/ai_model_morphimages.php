...
_load_language_file("/editor/ai_models/openai_model_morphimages_ai.inc");
...
$openAI_preset_models->type_list["morphImages"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["morphImages"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "morphImages";