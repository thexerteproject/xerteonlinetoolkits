...
_load_language_file("/editor/ai_models/openai_model_imagesequence_ai.inc");
...
$openAI_preset_models->type_list["imageSequence"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["imageSequence"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "imageSequence";