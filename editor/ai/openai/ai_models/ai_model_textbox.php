...
_load_language_file("/editor/ai_models/openai_model_textbox_ai.inc");
...
$openAI_preset_models->type_list["textbox"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["textbox"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "textbox";