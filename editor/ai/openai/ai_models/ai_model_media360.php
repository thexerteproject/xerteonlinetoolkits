...
_load_language_file("/editor/ai_models/openai_model_media360_ai.inc");
...
$openAI_preset_models->type_list["media360"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["media360"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "media360";