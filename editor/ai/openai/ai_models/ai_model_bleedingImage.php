...
_load_language_file("/editor/ai_models/openai_model_bleedingimage_ai.inc");
...
$openAI_preset_models->type_list["bleedingImage"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["bleedingImage"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "bleedingImage";