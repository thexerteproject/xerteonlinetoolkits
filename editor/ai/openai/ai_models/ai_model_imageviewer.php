...
_load_language_file("/editor/ai_models/openai_model_imageviewer_ai.inc");
...
$openAI_preset_models->type_list["imageViewer"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["imageViewer"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "imageViewer";