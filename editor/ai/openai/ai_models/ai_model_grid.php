...
_load_language_file("/editor/ai_models/openai_model_grid_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_GRID;
    $object = LEARNING_RESULT_BOOTSTRAP_GRID;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_GRID;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["grid"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["grid"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "grid";