...
_load_language_file("/editor/ai_models/openai_model_mcqstep_ai.inc");
...
if ($context === 'standard') {
        $q = LEARNING_PROMPT_MCQSTEP;
        $object = LEARNING_RESULT_MCQSTEP;
        $defaultPrompt = DEFAULT_PROMPT_MCQSTEP;

}
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_MCQSTEP_BOOTSTRAP;
    $object = LEARNING_RESULT_MCQSTEP_BOOTSTRAP;
    $defaultPrompt = DEFAULT_PROMPT_MCQSTEP_BOOTSTRAP;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["mcqStep"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["mcqStep"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "mcqStep";