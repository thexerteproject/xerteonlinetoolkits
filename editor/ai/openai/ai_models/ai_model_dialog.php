...
_load_language_file("/editor/ai_models/openai_model_dialog_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_DIALOG;
    $object = LEARNING_RESULT_BOOTSTRAP_DIALOG;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_DIALOG;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["dialog"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["dialog"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "dialog";