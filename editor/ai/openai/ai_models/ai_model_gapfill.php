...
_load_language_file("/editor/ai_models/openai_model_gapfill_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_GAPFILL;
    $object = LEARNING_RESULT_BOOTSTRAP_GAPFILL;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_GAPFILL;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["gapFill"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["gapFill"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "gapFill";