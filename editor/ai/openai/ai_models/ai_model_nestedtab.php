...
_load_language_file("/editor/ai_models/openai_model_nestedtab_ai.inc");
...
$openAI_preset_models->type_list["nestedTab"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["nestedTab"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "nestedTab";