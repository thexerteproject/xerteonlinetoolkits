...
_load_language_file("/editor/ai_models/openai_model_tabledoc_ai.inc");
...
$openAI_preset_models->type_list["tableDoc"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["tableDoc"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "tableDoc";