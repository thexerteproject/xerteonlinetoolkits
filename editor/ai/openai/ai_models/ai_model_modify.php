...
_load_language_file("/editor/ai_models/openai_model_modify_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BOOTSTRAP_MODIFY;
    $object = LEARNING_RESULT_BOOTSTRAP_MODIFY;
    $defaultPrompt = DEFAULT_PROMPT_BOOTSTRAP_MODIFY;
}
if ($assistantOn){
...
$openAI_preset_models->type_list["modify"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["modify"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "modify";