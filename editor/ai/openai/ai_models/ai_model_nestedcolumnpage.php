...
_load_language_file("/editor/ai_models/openai_model_nestedcolumnpage_ai.inc");
...
$openAI_preset_models->type_list["nestedColumnPage"] = ["payload" => $payload, "url" => $chat_url];

$openAI_preset_models->prompt_list["nestedColumnPage"] = explode(",", $defaultPrompt);

$openAI_preset_models->multi_run[] = "nestedColumnPage";