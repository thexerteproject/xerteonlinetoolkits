...
_load_language_file("/editor/ai_models/anthropic_model_movie_ai.inc");
...
$anthropic_preset_models->type_list["movie"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["movie"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "movie";