...
_load_language_file("/editor/ai_models/anthropic_model_timeline_ai.inc");
...
$anthropic_preset_models->type_list["timeline"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["timeline"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "timeline";