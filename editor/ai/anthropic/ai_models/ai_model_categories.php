...
$anthropic_preset_models->type_list["categories"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["categories"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "categories";