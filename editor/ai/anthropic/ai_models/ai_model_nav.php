...
_load_language_file("/editor/ai_models/anthropic_model_nav_ai.inc");
...
$anthropic_preset_models->type_list["nav"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["nav"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "nav";