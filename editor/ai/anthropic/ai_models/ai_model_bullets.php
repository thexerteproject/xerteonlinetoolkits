...
_load_language_file("/editor/ai_models/anthropic_model_bullets_ai.inc");
...
if ($context === 'standard') {
    $q = LEARNING_PROMPT_BULLETS;
    $object = LEARNING_RESULT_BULLETS;
    $defaultPrompt = DEFAULT_PROMPT_BULLETS;
}
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_BULLETS_BOOTSTRAP;
    $object = LEARNING_RESULT_BULLETS_BOOTSTRAP;
    $defaultPrompt = DEFAULT_PROMPT_BULLETS_BOOTSTRAP;
}
...
$anthropic_preset_models->type_list["bullets"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["bullets"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "bullets";