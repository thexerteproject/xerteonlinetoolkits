...
_load_language_file("/editor/ai_models/anthropic_model_ivoverlaypanel_ai.inc");
...
$anthropic_preset_models->type_list["ivOverlayPanel"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["ivOverlayPanel"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "ivOverlayPanel";