...
_load_language_file("/editor/ai_models/anthropic_model_crossword_ai.inc");
...
$anthropic_preset_models->type_list["crossword"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["crossword"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "crossword";