...
_load_language_file("/editor/ai_models/anthropic_model_dialog_ai.inc");
...
if ($context === 'standard') {
    $q = LEARNING_PROMPT_DIALOG;
    $object = LEARNING_RESULT_DIALOG;
    $defaultPrompt = DEFAULT_PROMPT_DIALOG;
}
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_DIALOG_BOOTSTRAP;
    $object = LEARNING_RESULT_DIALOG_BOOTSTRAP;
    $defaultPrompt = DEFAULT_PROMPT_DIALOG_BOOTSTRAP;
}
...
$anthropic_preset_models->type_list["dialog"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["dialog"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "dialog";