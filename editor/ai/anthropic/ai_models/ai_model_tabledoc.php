...
_load_language_file("/editor/ai_models/anthropic_model_tabledoc_ai.inc");
...
$anthropic_preset_models->type_list["tableDoc"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["tableDoc"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "tableDoc";