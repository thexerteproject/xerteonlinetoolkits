<?php
//topxq model using gpt-3.5 turbo
require_once(dirname(__FILE__) . "/../../../../config.php");
_load_language_file("/editor/ai_models/anthropic_model_topxq_ai.inc");
...
if ($context === 'standard') {
    $q = DEFAULT_PROMPT_TOPXQ;
    $object = DEFAULT_PROMPT_TOPXQ;
    $defaultPrompt = DEFAULT_PROMPT_TOPXQ;
}
elseif ($context === 'bootstrap') {
    $q = DEFAULT_PROMPT_TOPXQ_BOOTSTRAP;
    $object = DEFAULT_PROMPT_TOPXQ_BOOTSTRAP;
...
$anthropic_preset_models->type_list["topXQ"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["topXQ"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "topXQ";