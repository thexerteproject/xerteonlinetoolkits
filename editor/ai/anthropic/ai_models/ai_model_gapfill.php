...
_load_language_file("/editor/ai_models/anthropic_model_gapfill_ai.inc");
...
$anthropic_preset_models->type_list["gapFill"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["gapFill"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "gapFill";