...
_load_language_file("/editor/ai_models/anthropic_model_nestedpage_ai.inc");
...
$anthropic_preset_models->type_list["nestedPage"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["nestedPage"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "nestedPage";