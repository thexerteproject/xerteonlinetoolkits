...
_load_language_file("/editor/ai_models/anthropic_model_orient_ai.inc");
...
$anthropic_preset_models->type_list["orient"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["orient"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "orient";