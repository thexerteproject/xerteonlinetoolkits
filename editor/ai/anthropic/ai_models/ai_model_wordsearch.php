...
_load_language_file("/editor/ai_models/anthropic_model_wordsearch_ai.inc");
...
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_WORDSEARCH_BOOTSTRAP;
    $object = LEARNING_RESULT_WORDSEARCH_BOOTSTRAP;
    $defaultPrompt = DEFAULT_PROMPT_WORDSEARCH_BOOTSTRAP;
}
...
$anthropic_preset_models->type_list["wordsearch"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["wordsearch"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "wordsearch";