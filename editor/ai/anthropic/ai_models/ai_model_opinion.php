...
_load_language_file("/editor/ai_models/anthropic_model_opinion_ai.inc");
...
$anthropic_preset_models->type_list["opinion"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["opinion"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "opinion";