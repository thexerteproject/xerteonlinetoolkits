...
_load_language_file("/editor/ai_models/anthropic_model_textarea_ai.inc");
...
$anthropic_preset_models->type_list["textarea"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["textarea"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "textarea";