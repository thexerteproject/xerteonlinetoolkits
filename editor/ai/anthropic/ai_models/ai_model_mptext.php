...
_load_language_file("/editor/ai_models/anthropic_model_mptext_ai.inc");
...
$anthropic_preset_models->type_list["mpText"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["mpText"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "mpText";