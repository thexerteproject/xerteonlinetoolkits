...
_load_language_file("/editor/ai_models/anthropic_model_hangman_ai.inc");
...
$anthropic_preset_models->type_list["hangman"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["hangman"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "hangman";