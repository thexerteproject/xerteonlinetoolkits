...
_load_language_file("/editor/ai_models/anthropic_model_textbox_ai.inc");
...
if ($context === 'standard') {
    $q = LEARNING_PROMPT_TEXTBOX;
    $object = LEARNING_RESULT_TEXTBOX;
    $defaultPrompt = DEFAULT_PROMPT_TEXTBOX;
}
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_TEXTBOX_BOOTSTRAP;
    $object = LEARNING_RESULT_TEXTBOX_BOOTSTRAP;
    $defaultPrompt = DEFAULT_PROMPT_TEXTBOX_BOOTSTRAP;
}
...
$anthropic_preset_models->type_list["textbox"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["textbox"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "textbox";