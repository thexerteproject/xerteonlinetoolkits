...
_load_language_file("/editor/ai_models/anthropic_model_sound_ai.inc");
...
$anthropic_preset_models->type_list["sound"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["sound"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "sound";