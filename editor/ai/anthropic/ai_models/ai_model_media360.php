...
_load_language_file("/editor/ai_models/anthropic_model_media360_ai.inc");
...
$anthropic_preset_models->type_list["media360"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["media360"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "media360";