...
_load_language_file("/editor/ai_models/anthropic_model_buttonsequence_ai.inc");
...
$anthropic_preset_models->type_list["buttonSequence"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["buttonSequence"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "buttonSequence";