...
_load_language_file("/editor/ai_models/anthropic_model_flickr_ai.inc");
...
if ($context === 'standard') {
    $q = LEARNING_PROMPT_FLICKR;
    $object = LEARNING_RESULT_FLICKR;
    $defaultPrompt = DEFAULT_PROMPT_FLICKR;
}
elseif ($context === 'bootstrap') {
    $q = LEARNING_PROMPT_FLICKR_BOOTSTRAP;
    $object = LEARNING_RESULT_FLICKR_BOOTSTRAP;
    $defaultPrompt = DEFAULT_PROMPT_FLICKR_BOOTSTRAP;
}
...
$anthropic_preset_models->type_list["flickr"] = ["payload" => $payload, "url" => $chat_url];

$anthropic_preset_models->prompt_list["flickr"] = explode(",", $defaultPrompt);

$anthropic_preset_models->multi_run[] = "flickr";