...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.extraPlugins = 'dialog,widget,extmathjax,image3,codemirror,oembed,xotlink,xotmarkword,fontawesome,uploadimage,html5audio,xotrecorder,rubytext,wrapstyle,link,emoji,xotlightbox,numericinput,lineheight';
